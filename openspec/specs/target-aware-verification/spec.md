# target-aware-verification Specification

## Purpose

Define explicit change selection, immutable target baselines, drift handling, and auditable evidence for repository verification skills.
