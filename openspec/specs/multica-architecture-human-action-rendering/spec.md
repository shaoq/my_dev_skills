# multica-architecture-human-action-rendering Specification

## Purpose
Render portable architecture Human Action Requests as decision-first Multica comments and keep operational write authority explicit, scoped and separate from architecture approval.
